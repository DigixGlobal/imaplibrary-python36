NOTE: This repository is duplicate copy of peritus repository (https://github.com/peritus/robotframework-imaplibrary) and rickypc repository (https://github.com/rickypc/robotframework-imaplibrary) to fix the problem on some functions that will make compatible on python 3.6
